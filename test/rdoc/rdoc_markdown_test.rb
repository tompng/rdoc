...
:   This is another definition
  ...
  def test_brace_bracket_escape
    doc = parse "[label](url) {brace}\\[notlabel](noturl) {brace}[notlabel\\](noturl)"
    expected = doc(para("{label}[url] \\{brace\\}\\[notlabel\\](noturl) \\{brace\\}\\[notlabel\\](noturl)"))
    assert_equal expected, doc
  end
