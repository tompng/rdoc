...
class RDoc::Parser::C < RDoc::Parser
  ...
  def add_alias(var_name, class_obj, old_name, new_name, comment)
    al = RDoc::Alias.new nil, old_name, new_name, comment, singleton: @singleton_classes.key?(var_name)
  ...
  def handle_attr(var_name, attr_name, read, write)
    ...
    attr = RDoc::Attr.new nil, name, rw, comment
  ...
  def handle_method(type, var_name, meth_name, function, param_count,
    ...
    if class_obj then
      ...
      meth_obj = RDoc::AnyMethod.new nil, meth_name, singleton: singleton
